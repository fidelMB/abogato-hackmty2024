...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(38690181093369699288)
,p_plug_name=>'&APP_USER.'
,p_region_template_options=>'#DEFAULT#:t-HeroRegion--hideIcon'
,p_plug_template=>wwv_flow_imp.id(38689941731718699097)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(38690181467353699288)
,p_plug_name=>'&APP_USER.'
...
wwv_flow_imp_page.create_card(
 p_id=>wwv_flow_imp.id(38690181920272699288)
,p_region_id=>wwv_flow_imp.id(38690181467353699288)
,p_layout_type=>'ROW'
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(38690182458797699289)
,p_plug_name=>'Settings'
,p_region_template_options=>'#DEFAULT#'
,p_component_template_options=>'#DEFAULT#:t-MediaList--showBadges:u-colors'
,p_plug_template=>wwv_flow_imp.id(38689908190190699083)
,p_plug_display_sequence=>30
,p_list_id=>wwv_flow_imp.id(38690180019049699287)
