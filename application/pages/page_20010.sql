...
,p_group_id=>wwv_flow_imp.id(38690175939739699283)
,p_javascript_code_onload=>'apex.pwa.initPushSubscriptionPage();'
,p_step_template=>wwv_flow_imp.id(38689872213752699066)
,p_page_template_options=>'#DEFAULT#:js-dialog-class-t-Drawer--pullOutEnd'
,p_required_patch=>wwv_flow_imp.id(38690176130368699283)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(38690177469643699285)
...
,p_plug_template=>wwv_flow_imp.id(38689902901922699081)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(38690177863223699285)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(38690177112855699284)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(38690178302155699286)
,p_name=>'P20010_ENABLE_PUSH'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(38690177863223699285)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(38690178668083699286)
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(38690179178662699286)
,p_event_id=>wwv_flow_imp.id(38690178668083699286)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(38690179684400699287)
,p_event_id=>wwv_flow_imp.id(38690178668083699286)
