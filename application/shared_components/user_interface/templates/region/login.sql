...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38689969819371699110)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689970187541699110)
,p_plug_template_id=>wwv_flow_imp.id(38689969819371699110)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689970440215699110)
,p_plug_template_id=>wwv_flow_imp.id(38689969819371699110)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689970761444699110)
,p_plug_template_id=>wwv_flow_imp.id(38689969819371699110)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689971084818699110)
,p_plug_template_id=>wwv_flow_imp.id(38689969819371699110)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689971390777699111)
,p_plug_template_id=>wwv_flow_imp.id(38689969819371699110)
,p_name=>'Sub Regions'
