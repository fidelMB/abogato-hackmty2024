...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38689908190190699083)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689908486675699083)
,p_plug_template_id=>wwv_flow_imp.id(38689908190190699083)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689908776049699083)
,p_plug_template_id=>wwv_flow_imp.id(38689908190190699083)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689909085350699083)
,p_plug_template_id=>wwv_flow_imp.id(38689908190190699083)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689909334593699083)
,p_plug_template_id=>wwv_flow_imp.id(38689908190190699083)
,p_name=>'Sub Regions'
