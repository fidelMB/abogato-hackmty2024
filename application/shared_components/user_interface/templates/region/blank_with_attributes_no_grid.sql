...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38689909509655699083)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689909848235699084)
,p_plug_template_id=>wwv_flow_imp.id(38689909509655699083)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689910155819699084)
,p_plug_template_id=>wwv_flow_imp.id(38689909509655699083)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689910467761699084)
,p_plug_template_id=>wwv_flow_imp.id(38689909509655699083)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689910766705699084)
,p_plug_template_id=>wwv_flow_imp.id(38689909509655699083)
,p_name=>'Sub Regions'
