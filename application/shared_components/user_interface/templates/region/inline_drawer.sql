...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38689955258545699103)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689955555923699104)
,p_plug_template_id=>wwv_flow_imp.id(38689955258545699103)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689955813400699104)
,p_plug_template_id=>wwv_flow_imp.id(38689955258545699103)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689956102890699104)
,p_plug_template_id=>wwv_flow_imp.id(38689955258545699103)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689956400490699104)
,p_plug_template_id=>wwv_flow_imp.id(38689955258545699103)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689956739637699104)
,p_plug_template_id=>wwv_flow_imp.id(38689955258545699103)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689957009169699104)
,p_plug_template_id=>wwv_flow_imp.id(38689955258545699103)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689957320889699104)
,p_plug_template_id=>wwv_flow_imp.id(38689955258545699103)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689957625225699104)
,p_plug_template_id=>wwv_flow_imp.id(38689955258545699103)
,p_name=>'Sub Regions'
