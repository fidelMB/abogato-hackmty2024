...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38689992524873699120)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689992826867699120)
,p_plug_template_id=>wwv_flow_imp.id(38689992524873699120)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689993151328699120)
,p_plug_template_id=>wwv_flow_imp.id(38689992524873699120)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689993410246699120)
,p_plug_template_id=>wwv_flow_imp.id(38689992524873699120)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689993723248699120)
,p_plug_template_id=>wwv_flow_imp.id(38689992524873699120)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689994080592699120)
,p_plug_template_id=>wwv_flow_imp.id(38689992524873699120)
