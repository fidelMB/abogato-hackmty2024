...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38689967371516699109)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689967646069699109)
,p_plug_template_id=>wwv_flow_imp.id(38689967371516699109)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689967969689699109)
,p_plug_template_id=>wwv_flow_imp.id(38689967371516699109)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689968236525699109)
,p_plug_template_id=>wwv_flow_imp.id(38689967371516699109)
,p_name=>'Button Start'
