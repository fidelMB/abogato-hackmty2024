...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38689950696777699101)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689950954233699101)
,p_plug_template_id=>wwv_flow_imp.id(38689950696777699101)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689951235045699102)
,p_plug_template_id=>wwv_flow_imp.id(38689950696777699101)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689951580675699102)
,p_plug_template_id=>wwv_flow_imp.id(38689950696777699101)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689951833774699102)
,p_plug_template_id=>wwv_flow_imp.id(38689950696777699101)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689952142118699102)
,p_plug_template_id=>wwv_flow_imp.id(38689950696777699101)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689952404632699102)
,p_plug_template_id=>wwv_flow_imp.id(38689950696777699101)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689952708500699102)
,p_plug_template_id=>wwv_flow_imp.id(38689950696777699101)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689953024302699102)
,p_plug_template_id=>wwv_flow_imp.id(38689950696777699101)
,p_name=>'Sub Regions'
