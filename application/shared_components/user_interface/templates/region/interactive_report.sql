...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38689965286907699108)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689965511022699108)
,p_plug_template_id=>wwv_flow_imp.id(38689965286907699108)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689965870902699108)
,p_plug_template_id=>wwv_flow_imp.id(38689965286907699108)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689966124942699108)
,p_plug_template_id=>wwv_flow_imp.id(38689965286907699108)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689966436775699108)
,p_plug_template_id=>wwv_flow_imp.id(38689965286907699108)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689966727665699109)
,p_plug_template_id=>wwv_flow_imp.id(38689965286907699108)
,p_name=>'Sub Regions'
