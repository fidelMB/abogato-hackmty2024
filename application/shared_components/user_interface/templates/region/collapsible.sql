...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38689927191763699091)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689927434253699091)
,p_plug_template_id=>wwv_flow_imp.id(38689927191763699091)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689927793634699091)
,p_plug_template_id=>wwv_flow_imp.id(38689927191763699091)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689928077821699091)
,p_plug_template_id=>wwv_flow_imp.id(38689927191763699091)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689928306878699091)
,p_plug_template_id=>wwv_flow_imp.id(38689927191763699091)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689928694758699092)
,p_plug_template_id=>wwv_flow_imp.id(38689927191763699091)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689928949345699092)
,p_plug_template_id=>wwv_flow_imp.id(38689927191763699091)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689929249773699092)
,p_plug_template_id=>wwv_flow_imp.id(38689927191763699091)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689929512754699092)
,p_plug_template_id=>wwv_flow_imp.id(38689927191763699091)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689929842929699092)
,p_plug_template_id=>wwv_flow_imp.id(38689927191763699091)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689930123892699092)
,p_plug_template_id=>wwv_flow_imp.id(38689927191763699091)
,p_name=>'Sub Regions'
