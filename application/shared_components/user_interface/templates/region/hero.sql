...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38689941731718699097)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689942080860699097)
,p_plug_template_id=>wwv_flow_imp.id(38689941731718699097)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689942343457699097)
,p_plug_template_id=>wwv_flow_imp.id(38689941731718699097)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689942610681699098)
,p_plug_template_id=>wwv_flow_imp.id(38689941731718699097)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689942956178699098)
,p_plug_template_id=>wwv_flow_imp.id(38689941731718699097)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689943288767699098)
,p_plug_template_id=>wwv_flow_imp.id(38689941731718699097)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
