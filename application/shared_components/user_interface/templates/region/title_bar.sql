...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38689987481020699118)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689987771027699118)
,p_plug_template_id=>wwv_flow_imp.id(38689987481020699118)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689988006453699118)
,p_plug_template_id=>wwv_flow_imp.id(38689987481020699118)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689988353695699118)
,p_plug_template_id=>wwv_flow_imp.id(38689987481020699118)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689988637938699118)
,p_plug_template_id=>wwv_flow_imp.id(38689987481020699118)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689988927013699118)
,p_plug_template_id=>wwv_flow_imp.id(38689987481020699118)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689989210381699118)
,p_plug_template_id=>wwv_flow_imp.id(38689987481020699118)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689989513667699119)
,p_plug_template_id=>wwv_flow_imp.id(38689987481020699118)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689989889810699119)
,p_plug_template_id=>wwv_flow_imp.id(38689987481020699118)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689990112545699119)
,p_plug_template_id=>wwv_flow_imp.id(38689987481020699118)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689990407627699119)
,p_plug_template_id=>wwv_flow_imp.id(38689987481020699118)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689990712742699119)
,p_plug_template_id=>wwv_flow_imp.id(38689987481020699118)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689991079969699119)
,p_plug_template_id=>wwv_flow_imp.id(38689987481020699118)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689991340602699119)
,p_plug_template_id=>wwv_flow_imp.id(38689987481020699118)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
