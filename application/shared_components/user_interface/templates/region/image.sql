...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38689945210260699099)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689945582090699099)
,p_plug_template_id=>wwv_flow_imp.id(38689945210260699099)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689945852545699099)
,p_plug_template_id=>wwv_flow_imp.id(38689945210260699099)
,p_name=>'Sub Regions'
