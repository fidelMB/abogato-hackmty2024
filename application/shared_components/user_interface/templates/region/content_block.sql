...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38689937107695699095)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689937467356699095)
,p_plug_template_id=>wwv_flow_imp.id(38689937107695699095)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689937764449699096)
,p_plug_template_id=>wwv_flow_imp.id(38689937107695699095)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689938081691699096)
,p_plug_template_id=>wwv_flow_imp.id(38689937107695699095)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689938392869699096)
,p_plug_template_id=>wwv_flow_imp.id(38689937107695699095)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689938685098699096)
,p_plug_template_id=>wwv_flow_imp.id(38689937107695699095)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689938987732699096)
,p_plug_template_id=>wwv_flow_imp.id(38689937107695699095)
,p_name=>'Sub Regions'
