...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38689959862005699106)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689960173424699106)
,p_plug_template_id=>wwv_flow_imp.id(38689959862005699106)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689960457141699106)
,p_plug_template_id=>wwv_flow_imp.id(38689959862005699106)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689960777718699106)
,p_plug_template_id=>wwv_flow_imp.id(38689959862005699106)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689961044831699106)
,p_plug_template_id=>wwv_flow_imp.id(38689959862005699106)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689961360470699106)
,p_plug_template_id=>wwv_flow_imp.id(38689959862005699106)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689961678357699106)
,p_plug_template_id=>wwv_flow_imp.id(38689959862005699106)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689961952296699107)
,p_plug_template_id=>wwv_flow_imp.id(38689959862005699106)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689962299866699107)
,p_plug_template_id=>wwv_flow_imp.id(38689959862005699106)
,p_name=>'Sub Regions'
