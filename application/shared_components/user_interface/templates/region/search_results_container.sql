...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38689972367139699111)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689972668497699111)
,p_plug_template_id=>wwv_flow_imp.id(38689972367139699111)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689972957134699111)
,p_plug_template_id=>wwv_flow_imp.id(38689972367139699111)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689973271563699111)
,p_plug_template_id=>wwv_flow_imp.id(38689972367139699111)
,p_name=>'Sub Regions'
