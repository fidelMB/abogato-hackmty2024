...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38689915274856699086)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689915578694699086)
,p_plug_template_id=>wwv_flow_imp.id(38689915274856699086)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689915896902699086)
,p_plug_template_id=>wwv_flow_imp.id(38689915274856699086)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689916106861699086)
,p_plug_template_id=>wwv_flow_imp.id(38689915274856699086)
,p_name=>'Sub Regions'
