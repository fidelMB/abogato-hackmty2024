...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(38689984834403699116)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689985124394699117)
,p_plug_template_id=>wwv_flow_imp.id(38689984834403699116)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689985461847699117)
,p_plug_template_id=>wwv_flow_imp.id(38689984834403699116)
,p_name=>'Tabs'
