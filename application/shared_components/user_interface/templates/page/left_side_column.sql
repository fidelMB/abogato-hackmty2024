...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(38689875190106699068)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689875437490699068)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689875754275699069)
,p_page_template_id=>wwv_flow_imp.id(38689875190106699068)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689876043438699069)
,p_page_template_id=>wwv_flow_imp.id(38689875190106699068)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689876314696699069)
,p_page_template_id=>wwv_flow_imp.id(38689875190106699068)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689876692378699069)
,p_page_template_id=>wwv_flow_imp.id(38689875190106699068)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689876986637699069)
,p_page_template_id=>wwv_flow_imp.id(38689875190106699068)
,p_name=>'Left Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689877296604699069)
,p_page_template_id=>wwv_flow_imp.id(38689875190106699068)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689877564107699069)
,p_page_template_id=>wwv_flow_imp.id(38689875190106699068)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689877860530699069)
,p_page_template_id=>wwv_flow_imp.id(38689875190106699068)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689878190014699069)
,p_page_template_id=>wwv_flow_imp.id(38689875190106699068)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689878488136699069)
,p_page_template_id=>wwv_flow_imp.id(38689875190106699068)
