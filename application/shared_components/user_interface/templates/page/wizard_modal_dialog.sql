...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(38689901412792699080)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689901719217699080)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689902009176699080)
,p_page_template_id=>wwv_flow_imp.id(38689901412792699080)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689902370975699080)
,p_page_template_id=>wwv_flow_imp.id(38689901412792699080)
