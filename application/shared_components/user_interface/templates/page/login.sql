...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(38689882808024699072)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689883168229699072)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689883418668699072)
,p_page_template_id=>wwv_flow_imp.id(38689882808024699072)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689883741122699072)
,p_page_template_id=>wwv_flow_imp.id(38689882808024699072)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(38689884086674699072)
,p_page_template_id=>wwv_flow_imp.id(38689882808024699072)
,p_name=>'Body Footer'
